...
class BertSelfAttention(nn.Module):
  ...
  def attention(self, key, query, value, attention_mask):
    ...
    # first I will get bs, num_attention_heads, sequence length, attention head size
    ...
    # Step 7: Concatenate the multi-heads and recover the original shape
    context_layer = context_layer.transpose(1, 2).contiguous().view(bs, -1, self.all_head_size)
...
class BertLayer(nn.Module):
  ...
  # This is important for grading purpose.
